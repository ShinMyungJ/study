...
model_path = "".join([filepath, 'k28_5_', datetime, '_', filename])
...
# Dropout을 모두 사용한 경우 성능이 상승함
# loss :  0.1219792440533638
# accurcy :  0.9814814925193787

# Dropout을 두번만 사용한 경우 비슷한 결과를 보임
# loss :  0.09616678953170776
# accurcy :  0.9629629850387573