...
model_path = "".join([filepath, 'k28_1_', datetime, '_', filename])
...
# 모두 dropout을 사용했을 경우 성능이 떨어짐
# loss :  21.055025100708008
# r2 스코어 :  0.7451492994308635

# dropout을 하나 혹은 둘을 사용했을 경우 성능이 조금 덜 떨어짐
# loss :  18.55474281311035
# r2 스코어 :  0.775412812347911