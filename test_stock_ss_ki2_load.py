...
# model.save("./_save/exam/{0}_{1}.h5".format(result1[-1][-1],result2[-1][-1]))

print('삼성전자 12/21 거래량 : ', result1[-1][-1],'주')
print('키움증권 12/21 거래량 : ', result2[-1][-1],'주')


# 삼성전자 12/21 거래량 :  12823893.0 주
# 키움증권 12/21 거래량 :  45555.53 주

# MaxAbsScaler
# 삼성전자 12/21 거래량 :  12905606.0 주
# 키움증권 12/21 거래량 :  79445.08 주

# RobustScaler
# 삼성전자 12/21 거래량 :  7695776.5 주
# 키움증권 12/21 거래량 :  49908.53 주

# MinMaxScaler
# 삼성전자 12/21 거래량 :  10536980.0 주
# 키움증권 12/21 거래량 :  70622.1 주

# StandardScaler
# 삼성전자 12/21 거래량 :  10437603.0 주
# 키움증권 12/21 거래량 :  69149.79 주