...
# print(x2, "\n", y2)
'''
print(x1.shape, y1.shape)     # (194, 5, 6) (194, 3)
print(x2.shape, y2.shape)     # (194, 5, 6) (194, 3)
pred1 = x_ss[-5:,1:]          # (5, 6)
pred2 = x_ki[-5:,1:]          # (5, 6)
...
print(x1_train.shape, x1_test.shape)  #(135, 5, 6) (59, 5, 5)
print(x2_train.shape, x2_test.shape)  #(135, 5, 6) (59, 5, 5)
...
dense3 = Dense(17, activation='relu', name = 'dense3')(dense2)
output1 = Dense(7, activation='relu', name = 'output1')(dense3)

#2-2 모델2
input2 = Input((5,6))
dense11 = LSTM(10, activation='relu', name = 'dense11')(input2)
dense12 = Dense(45, activation='relu', name = 'dense12')(dense11)
dense13 = Dense(30, activation='relu', name = 'dense13')(dense12)
dense14 = Dense(15, activation='relu', name = 'dense14')(dense13)
...
start = time.time()
hist = model.fit([x1_train, x2_train], [y1_train, y2_train], epochs=20, batch_size=1, validation_split=0.3, callbacks=[es, mcp])
end = time.time() - start
...
# model.save("./_save/exam/{0}{1}.h5".format(pred1[-1],pred2[-1]))
# print('삼성전자 12/21 거래량 : ', result1[-1],'주')
# print('키움증권 12/21 거래량 : ', result2[-1],'주')
