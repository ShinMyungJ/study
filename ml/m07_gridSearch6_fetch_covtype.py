...
parameters = [
    ...
    {'n_estimators' : [100,200], 'min_samples_leaf' : [3, 5, 7, 10]}                                        # 8 
]                                                                                                           # 총 48

#2. 모델 구성
model = GridSearchCV(RandomForestClassifier(), parameters, cv=kfold, verbose=3,    # model : 어떤 모델도 다 쓸 수 있다, parameters : 해당 모델의 파라미터 사용
