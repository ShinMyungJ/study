...
#2. 모델 구성
model = RandomizedSearchCV(RandomForestClassifier(), parameters, cv=kfold, verbose=1,    # model : 어떤 모델도 다 쓸 수 있다, parameters : 해당 모델의 파라미터 사용
...
# 최적의 파라미터 :  {'n_estimators': 200, 'min_samples_leaf': 3, 'max_depth': 6}
# best_score_ :  0.95
# model.score :  0.9333333333333333
# accuracy_score :  0.9333333333333333
# 최적 튠 ACC :  0.9333333333333333
# 걸린시간 :  3.4991776943206787