...
#2. 모델 구성
model = GridSearchCV(RandomForestRegressor(), parameters, cv=kfold, verbose=1,    # model : 어떤 모델도 다 쓸 수 있다, parameters : 해당 모델의 파라미터 사용
...
# best_score_ :  0.8382544459629238
# model.score :  0.9229536238833218
# accuracy_score :  0.9229536238833218
# 최적 튠 ACC :  0.9229536238833218
# 걸린시간 :  12.52102780342102