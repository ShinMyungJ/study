...
w2 = tf.compat.v1.Variable(tf.random.normal([5,8]), name='weight2')
b2 = tf.compat.v1.Variable(tf.random.normal([8]), name='bias2')
Hidden_layer2 = tf.sigmoid(tf.matmul(Hidden_layer1, w2) + b2)

w3 = tf.compat.v1.Variable(tf.random.normal([8,3]), name='weight3')
b3 = tf.compat.v1.Variable(tf.random.normal([3]), name='bias3')
Hidden_layer3 = tf.sigmoid(tf.matmul(Hidden_layer2, w3) + b3)

w4 = tf.compat.v1.Variable(tf.random.normal([3,1]), name='weight4')
